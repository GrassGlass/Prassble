...
\end{answer}
These are some hyperlinks with \TeXinline{zref-clever}: \zcref{ex:1.1}, \zcref{ex:1.2}, \zcref{ex:H.1.1}, \zcref{ex:H.1.2}, \zcref{ex:H.1.3}. We can also reference theorems: \zcref{thm:1.1}. 
\newpage
...
\end{exercise}
\backmatter
\extref{https://en.wikipedia.org/wiki/Orthogonal_complement#:~:text=In%20the%20mathematical%20fields%20of,perp%2C%20short%20for%20perpendicular%20complement.}{external link}
