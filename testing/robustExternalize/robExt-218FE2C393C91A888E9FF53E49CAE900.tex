\documentclass[,margin=30cm]{standalone}
  \usepackage [skins, breakable]{tcolorbox} \usepackage {keytheorems} \input {../../preamble/environments/box_styles/nonlistings/theoremstyles.tex} \modifednewkeytheorem {claim,proposition,lemma,theorem,corollary} [ ,style:V = \redbox ,sibling = definition ] 
