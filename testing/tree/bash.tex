...
\ExplSyntaxOn
  ...
  \str_new:N \g__Prassble_filetree_sys_shell_now_str
  \str_new:N \g__Prassble_FileTree_pathkey_str
  ...
  \keys_define:nn {Prassble_filetree} {
    ...
    ,pathkey        .str_set:N   = \g__Prassble_FileTree_pathkey_str
  }
  ...
  % Default output location
    ...
    % File path parsed to file_tree.sh
      ...
      \str_set:Ne \g__Prassble_filetree_sys_shell_now_str {
        % Execute the bash script file_tree.sh
          bash~file_tree.sh
        \c_space_tl
        % -i flag
          \g__Prassble_filetree_final_i_str
        \c_space_tl
        % -I flag (activated only if the string is nonempty)
          \g__Prassble_filetree_final_I_str
        \c_space_tl
        % -O flag
          \g__Prassble_filetree_final_Output_To_str
        \c_space_tl
        % File path parsed to file_tree.sh (the argument of file_tree.sh)
          \g__Prassble_filetree_file_path_str
      }

      \sys_shell_now:e {\g__Prassble_filetree_sys_shell_now_str}

      \file_input:V \g__Prassble_filetree_Output_To_str
    \group_end:
  }
...
\makeatletter
  ...
  \NewDocumentCommand{\FileTree}{ s O{} m }{
    ...
    \seq_gput_right:Ne \l_tmpa_seq {\g__Prassble_FileTree_pathkey_str}
    \seq_map_inline:Nn \g__Prassble_FileTree_pathkey_str {
      \__Prassble_Input@core:nnnn { #1 } { ##1 } { #3 } { \str_set:Ne \l__Prassble_FileTree_full_path_str }
    }
