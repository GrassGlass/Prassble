...
\ExplSyntaxOn
  ...
  % Default output location
    ...
    % File path parsed to file_tree.sh
      ...
      \sys_shell_now:e {bash~file_tree.sh\space\g__Prassble_filetree_final_i_str\space\g__Prassble_filetree_final_I_str\space\g__Prassble_filetree_final_Output_To_str\space\g__Prassble_filetree_file_path_str}
