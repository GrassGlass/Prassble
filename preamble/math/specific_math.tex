...
\ExplSyntaxOn
\tl_new:N \l__PrassbleMath_tmp_matrix_tl
\NewDocumentEnvironment{pMatrix}{ O{} +b }
{
\tl_if_eq:eeT {#1} {hat} 
    {
        \tl_set:Nn \l__PrassbleMath_tmp_matrix_tl 
            {
                \begin{matrix}
                    #2
                \end{matrix}
            }
        \vphantom{\reallywidehat{\l__PrassbleMath_tmp_matrix_tl}}
        \left(\smash{\reallywidehat{\l__PrassbleMath_tmp_matrix_tl}}\vphantom{\l__PrassbleMath_tmp_matrix_tl}\right)
    }
\tl_if_blank:eT {#1} 
    {
        \begin{pmatrix}
...
%     \NewDocumentCommand{\l_PrassbleMath_colonspace_hphantom}{}{\hphantom{\vcentcolon \mathrel {\mkern -1.2mu}}}

%     \NewDocumentCommand{\coloneqCOL}{}{\coloneq\l_PrassbleMath_colonspace_hphantom}
%     \NewDocumentCommand{\COLeqcolon}{}{\l_PrassbleMath_colonspace_hphantom\eqcolon}
%     \NewDocumentCommand{\COLeqCOL}{}{\l_PrassbleMath_colonspace_hphantom =\l_PrassbleMath_colonspace_hphantom}
% \ExplSyntaxOff
