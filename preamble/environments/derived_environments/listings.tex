...
%* Listings to print code out verbatim (minted)
    ...
    % environments
        ...
        \NewPCBListing{code}{ D(){middle} ={OTitle} O{} m }{
            ,codestyleenvironment = {#3}{#3}
            ,type in thmgroup = {#1}
            ,#2
        }
        \NewPCBListing{codeoutput}{ D(){middle} ={OTitle} O{} m }{
    ...
    % Input commands
        ...
        \NewPCBInputListing{\InputCode}{ D(){middle} ={OTitle} O{} m }{
            ,codestyleinput* = {#3}{\displayedname}
            ,type in thmgroup = {#1}
            ,#2
            ,Inputify = {#3}
            ,listing file = {\inputPath}
        }
        ...
        \NewPCBInputListing{\InputCodeOutput}{ D(){middle} ={OTitle} O{} m }{
