...
%* Listings to print code out verbatim (minted)
    ...
    % Input commands
        ...
        \ModifiedNewTCBInputListing{\inputcode}{ D(){middle} s ={OTitle} O{} m }{
            ,type in thmgroup = {#1*}
            ,codestyleinput = {#4}{\displayedname}
            ,#3
        }

        \ModifiedNewTCBInputListing{\inputcodeoutput}{ D(){middle} s ={OTitle} O{} m }{
            ,type in thmgroup = {#1*}
            ,codestyleinput = {#4}{Output}
            ,#3
        }
