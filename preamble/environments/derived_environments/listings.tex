...
%* Listings to print code out verbatim (minted)
    ...
    % environments
        ...
        \ModifiedNewTCBListing{code}{ ={OTitle}  O{} m }{
            ,vflush
            ,codestyleenvironment = {#2}{#2}
            ,#1
        }
        \ModifiedNewTCBListing{code*}{ ={OTitle}  O{} m }{
            ,vnormal
        ...
        \ModifiedNewTCBListing{codeoutput}{ ={OTitle}  O{} m }{
            ,vflush
            ,codestyleenvironment = {#2}{Output}
            ,#1
        }
        \ModifiedNewTCBListing{codeoutput*}{ ={OTitle}  O{} m }{
            ,vnormal
    ...
    % Input commands
        ...
        \ModifiedNewTCBInputListing{\inputcode}{ s ={OTitle} O{} m }{
            ,IfBooleanTF = {#1}{vnormal}{vflush}
            ,codestyleinput = {#3}{\displayedname}
            ,#2
        }

        \ModifiedNewTCBInputListing{\inputcodeoutput}{ s ={OTitle} O{} m }{
            ,IfBooleanTF = {#1}{vnormal}{vflush}
