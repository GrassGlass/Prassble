...
% Keys whose values depend on the current pagestyle
    % parent
    \StyleDependentValue[Parent]{Definition}{main,hw}{chapter,}{\SelectedPagestyle}
    \StyleDependentValue[Parent]{Problem}{main,hw}{chapter,}{\SelectedPagestyle}
% Keys that enable coloured boxes iff 
    \StyleDependentValue{proofbox}{colourful,BnW}{proofbox,}{\SelectedColourTheme} 
    \StyleDependentValue{greenbox}{colourful,BnW}{greenbox,}{\SelectedColourTheme}
    \StyleDependentValue{redbox}{colourful,BnW}{redbox,}{\SelectedColourTheme}
    \StyleDependentValue{bluebox}{colourful,BnW}{bluebox}{\SelectedColourTheme}
    \StyleDependentValue{purplebox}{colourful,BnW}{purplebox}{\SelectedColourTheme}
