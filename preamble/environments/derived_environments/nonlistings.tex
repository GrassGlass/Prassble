...
% Keys whose values depend on the current boxstyle (which, by default, is the pagestyle)
    % parent
    \StyleDependentValue[Parent]{Definition}{main,hw-in-main,hw}{chapter,section,}{\SelectedPagestyle}
    \StyleDependentValue[Parent]{Problem}{main,hw-in-main,hw}{chapter,section,}{\SelectedPagestyle}
