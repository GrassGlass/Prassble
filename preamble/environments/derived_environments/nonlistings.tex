...
% Keys that enable coloured boxes iff 
    \StyleDependentValue{proofbox}{colourful,BnW}{proofbox-colourful,proofbox-BnW}{\ColourTheme} 
    \StyleDependentValue{greenbox}{colourful,BnW}{greenbox,BnW}{\ColourTheme}
    \StyleDependentValue{redbox}{colourful,BnW}{redbox,BnW}{\ColourTheme}
    \StyleDependentValue{bluebox}{colourful,BnW}{bluebox,BnW}{\ColourTheme}
    \StyleDependentValue{purplebox}{colourful,BnW}{purplebox,BnW}{\ColourTheme}

    % Proof/Answer environments
    \modifiedrenewkeytheorem*{proof}
    (last)
    [style:V = \proofbox]
    \modifiednewkeytheorem*{answer}
    (last)
    [style:V = \proofbox]
...
% Numbered
    % Family of environments with chapter as parent
        ...
        \modifiednewkeytheorem{definition}
        (standalone)
        [
            ,style:V = \greenbox
            ,parent:V = \DefinitionParent
        ]
        \modifiednewkeytheorem{notation,motivation,recall}
        (standalone)
        [
            ,style:V = \greenbox
            ,sibling = definition
        ...
        \modifiednewkeytheorem{claim,proposition,lemma,theorem,corollary}
        (first)
        [
            ,style:V = \redbox
            ,sibling = definition
        ...
        \modifiednewkeytheorem{observation,example,remark,note}
        (standalone)
        [
            ,style:V = \bluebox
            ,sibling = definition
    ...
    % Family of environments with section as parent, and a separate hw environment
        ...
        \modifiednewkeytheorem{problem}
        (first)
        [
            ,style:V = \purplebox
            ,parent:V = \ProblemParent
        ]
        \modifiednewkeytheorem{question,exercise}
        (first)
        [
            ,style:V = \purplebox
            ,sibling = problem
