...
% Controls the length of the code line number backgrounds
    % The code line number overlays have a background whose color is darker than the rest of the listing box, but lighter than the borderline to the left. This background has horizontal width \eqboxwidth{code\arabic{code}} + \linenumberpadding (including the \BorderlineWestThickness overlap with the borderline)
    \setlength{\linenumberpadding}{6.6pt}