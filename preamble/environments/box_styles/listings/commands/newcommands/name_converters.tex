...
% 
  % Messages
    ...
    % The \l_Prassble_listings_pygments_name_tl is not recognised at all
  ...
  \NewDocumentCommand{\AddFileExtensionLanguageTriple}{ m m m }{
    ...
    % Expand all elements of the local private clist #1 = \l__Prassble_listings_AddFileExtensionLanguageTriple_new_Pygments_languages_clist and store all its entries under the global public clist \\g_Prassble_listings_NameConverters_Pygments_languages_clist of all Pygments-understood languages
      ...
      \clist_map_inline:Nn \l__Prassble_listings_AddFileExtensionLanguageTriple_new_Pygments_languages_clist {
        ...
        % Error message
          % The \l_Prassble_listings_pygments_name_tl is not recognised at all
          \clist_if_in:NnF \g__Prassble_listings_all_pygments_understood_language_names_clist {##1} 
          {
...
%
  % The command \_Prassble_listings_file_extension_to_language:n that converts file extensions (e.g. txt) to the corresponding displayed language name in the title, and Pygments-understood language name (e.g. text).
  \cs_new:Npn \_Prassble_listings_file_extension_to_language:n #1 {
    ...
    \clist_if_in:NVTF \g_Prassble_listings_NameConverters_file_extensions_clist \l__Prassble_listings_FileExtensionToLanguage_citem_file_extension_tl
      ...
      {
        % Displayed language name \l_Prassble_listings_displayed_name_tl
        ...
        \tl_set:Nn \l_Prassble_listings_displayed_name_tl {\clist_item:Nn \g_Prassble_listings_NameConverters_displayed_languages_clist {\l__Prassble_number_in_clist_int}}
        % Pygments-understood language name \l_Prassble_listings_pygments_name_tl
        \__Prassble_number_in_clist:NV{\g_Prassble_listings_NameConverters_file_extensions_clist}{\l__Prassble_listings_FileExtensionToLanguage_citem_file_extension_tl}
        \tl_set:Ne \l_Prassble_listings_pygments_name_tl {\clist_item:Nn \g_Prassble_listings_NameConverters_Pygments_languages_clist {\l__Prassble_number_in_clist_int}}
      }
    % Otherwise, use the file extension as both the displayed language name and pygments-understood langauge name
      {
        \tl_set_eq:NN \l_Prassble_listings_displayed_name_tl \l__Prassble_listings_FileExtensionToLanguage_citem_file_extension_tl
        \tl_set_eq:NN \l_Prassble_listings_pygments_name_tl \l__Prassble_listings_FileExtensionToLanguage_citem_file_extension_tl
        % Error messages
          % The corresponding displayed name and pygments name was not found, for the given file extension
          ...
          % The \l_Prassble_listings_pygments_name_tl is not recognised at all
          \clist_if_in:NVF \g__Prassble_listings_all_pygments_understood_language_names_clist \l_Prassble_listings_pygments_name_tl 
          {
            \msg_error:nn {Listings} {invalid pygments short name}
          }
      }
...
%
  % The command \__Prassble_listings_displayed_to_pygments:n that converts displayed names to the corresponding language name that is understood by Pygments.
  \cs_new:Npn \__Prassble_listings_displayed_to_pygments:n #1 {
    % Defining the item #1 as a token list
      % Using \tl_set:Ne with \clist_if_in:NVT avoids expansion issues that occur with \clist_if_in:NnT
    ...
    \clist_if_in:NVTF \g_Prassble_listings_NameConverters_displayed_languages_clist \l__Prassble_listings_DisplayedToPygments_citem_displayed_tl
      % Then select and store the corresponding pygments-understood language name \l_Prassble_listings_pygments_name_tl
      {
    ...
    % Otherwise, use the displayed language name as the pygments-understood language name
      ...
      {
        \tl_set:Ne \l_Prassble_listings_pygments_name_tl {\text_lowercase:n {\l__Prassble_listings_DisplayedToPygments_citem_displayed_tl}}
        % Error messages
          % The corresponding displayed name and pygments name was not found, for the given file extension
