...
\NewDocumentCommand{\NumberInClist}{ m m }{
  ...
  \clist_map_inline:Nn #1 {
    ...
    \tl_set:Ne \l__Prassble_listings_NumberInClist_item_from_clist_tl {##1}
    \tl_set:Ne \l__Prassble_listings_NumberInClist_item_of_interest_tl {#2}
    % If the current item ##1 of the clist being mapped, #1, is the item #2 we are looking for,
    \tl_if_eq:NNTF \l__Prassble_listings_NumberInClist_item_from_clist_tl \l__Prassble_listings_NumberInClist_item_of_interest_tl
  ...
  \NewDocumentCommand{\FileExtensionToLanguage}{ m }{
    ...
    \clist_if_in:NVTF \g_Prassble_listings_NameConverters_file_extensions_clist \l__Prassble_listings_FileExtensionToLanguage_citem_file_extension_tl
      % Then select and store the corresponding displayed language name and pygments-understood language name
      {
        ...
        \NumberInClist{\g_Prassble_listings_NameConverters_file_extensions_clist}{\l__Prassble_listings_FileExtensionToLanguage_citem_file_extension_tl}
        \tl_set:Nn \displayedname {\clist_item:Nn \g_Prassble_listings_NameConverters_displayed_languages_clist {\numberinclist}}
        % Pygments-understood language name \pygmentsname
        \NumberInClist{\g_Prassble_listings_NameConverters_file_extensions_clist}{\l__Prassble_listings_FileExtensionToLanguage_citem_file_extension_tl}
        \tl_set:Ne \pygmentsname {\clist_item:Nn \g_Prassble_listings_NameConverters_Pygments_languages_clist {\numberinclist}}
      }
...
%
  ...
  \NewDocumentCommand{\DisplayedToPygments}{ m }{
    ...
    \clist_if_in:NVTF \g_Prassble_listings_NameConverters_displayed_languages_clist \l__Prassble_listings_DisplayedToPygments_citem_displayed_tl
      ...
      {
        \NumberInClist{\g_Prassble_listings_NameConverters_displayed_languages_clist}{\l__Prassble_listings_DisplayedToPygments_citem_displayed_tl}
        \tl_set:Ne \pygmentsname {\clist_item:Nn \g_Prassble_listings_NameConverters_Pygments_languages_clist {\numberinclist}}
      }
