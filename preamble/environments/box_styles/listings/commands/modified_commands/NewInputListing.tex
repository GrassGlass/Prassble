...
\makeatletter
\ExplSyntaxOn
  \NewDocumentCommand{\NewPCBInputListing}{ O{} m m m }{
    \NewTCBInputListing[ #1 ]{ #2 }{ #3 }{ #4 }
    \AddToHook{cmd/\cs_to_str:N #2/before}{
    ...
    \AddToHook{cmd/\cs_to_str:N #2/after}{
      % After \tcbinputlisting
        \__Prassble_listings_autowidth_lower_savewidth:%
