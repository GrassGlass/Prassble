  ...
  ,autowidth@core/.code = 
  {
    ...
    % The line width \g__listings_autowidth@core_measured_text_width_dim the box should be set to have (given this width is less than \g__listings_autowidth@core_max_tcb_width_dim, i.e. doesn't overflow into the margins)
      ...
      {0pt}
      {
        ...
        \dim_set:Nn \g__listings_autowidth@core_measured_text_width_dim {\g__listings_autowidth@core_max_tcb_width_dim}
      }
      {
...
% Base listing style
  ...
  ,codestylebase/.style =
  {
    ,left                            = {\g__listings_autowidth_true_left_hspace_dim}
