...
% Variables
  ...
  \cs_new:Npn \__listings_autowidth_lower_eqsavebox:n #1
  {
    \bool_if:NT
      ...
      {
        \eqsavebox{\codewidth}[codelowerwidth\arabic{code}]{#1}
      }
  }
          ...
          \begin{enumerate}
            \item \emph{\textbackslash eqboxwidth\{\__listings_debug_argument_formatter:n {tag}\}}
              \begin{enumerate}
                ...
                \item[codetitlewidth:] \eqboxwidth{codetitlewidth\arabic{code}}
                \item[codeupperwidth:] \eqboxwidth{codeupperwidth\arabic{code}}
                \item[codelowerwidth:] \eqboxwidth{codelowerewidth\arabic{code}}
              \end{enumerate}
            \item \emph{\textbackslash l\textunderscore\textunderscore listings\textunderscore autowidth\textunderscore \__listings_debug_argument_formatter:n {component}\textunderscore dim}
              \begin{enumerate}
                ...
                \item[title:] \dim_use:N \l__listings_autowidth_title_dim
                \item[upper:] \dim_use:N \l__listings_autowidth_upper_dim
                \item[lower:] \dim_use:N \l__listings_autowidth_lower_dim
              \end{enumerate}
        \end{enumerate}
        \rule{\textwidth}{1pt}
        }
