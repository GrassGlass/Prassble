...
% Listing keys
  ...
  ,autowidth@core/.code = 
  {
    % The line width \g__listings_autowidth@core_dim the box should be set to have (given this width is less than \linewidthoutside, i.e. doesn't overflow into the margins)
