...
\tcbset{
  ...
  ,autowidth@core/.code = 
  {
    % The line width \g__listings_autowidth@core_measured_text_width_dim the box should be set to have (given this width is less than \g__listings_autowidth@core_max_tcb_width_dim, i.e. doesn't overflow into the margins)
      \bool_if:NT \g__listings_autowidth_title_bool
      {
        ...
        {
          \eqboxwidth{codetitlewidth\arabic{code}}-\g__listings_Leftupper_dim
        }
      }
      ...
      \bool_if:NT \g__listings_autowidth_lower_bool
      {
        ...
        {
          \eqboxwidth{codelowerwidth\arabic{code}}-\g__listings_Leftupper_dim
        }
      }
  ...
  ,Leftupper/.code = {
    \dim_set:Nn \g__listings_Leftupper_dim {\eqboxwidth{code\arabic{code}}+\lefthspace+0.5\linenumberpadding}
    \pgfkeysalso{
...
% Base listing style
  ...
  ,codestylebase/.style =
  {
    ...
    ,after~lower                            = \__listings_autowidth_lower_savewidth: 
    ,overlay~unbroken                = {
