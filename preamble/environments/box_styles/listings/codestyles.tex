...
% Variables
  ...
  \dim_new:N \g__listings_autowidth_text_width_vs_width_difference_dim 
  \dim_new:N \g__listings_autowidth@core_max_tcb_text_width_dim
  \cs_new:Npn \__tcb_text_width_to_width:n #1
  {
    #1+\g__listings_autowidth_text_width_vs_width_difference_dim
  }
  ...
  \cs_new:Npn \__listings_debug_autowidth:
  {
    \bool_if:NT \g__listings_debug_autowidth_bool
        { 
          ...
          \item \codeinline{TeX}{\linewidthoutside}:\  \linewidthoutside
...
% Listing keys
  ...
  ,autowidth@core/.code = 
  {
    % The line width \g__listings_autowidth@core_measured_text_width_dim the box should be set to have (given this width is less than \linewidthoutside, i.e. doesn't overflow into the margins)
      ...
      \dim_set:Nn \g__listings_autowidth_text_width_vs_width_difference_dim  {\kvtcb@left@rule+\kvtcb@right@rule+\kvtcb@boxsep*2+\kvtcb@leftupper+\kvtcb@rightupper}
      \dim_set:Nn \g__listings_autowidth@core_max_tcb_text_width_dim {\__tcb_width_to_text_width:n {\linewidthoutside}}
