...
% Custom setup
  ...
  % Colored boxes
    ...
    % Listings
    \ifdefstring{\ColourTheme}{colourful}{
      \Input[environments/box_styles/listings/colourful/commands/newcommands]{%
        ,all_short_names.tex%
        ,new_variables.tex%
        ,name_converters.tex%
      }
      \Input[environments/box_styles/listings/colourful/commands/modified_commands]{%
        ,../../codestyles.tex%
        ,NewInputListing.tex%
        ,NewListing.tex%
      }
      \Input{environments/derived_environments/listings/listings-colourful.tex}
    }{}
