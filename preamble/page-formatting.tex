...
% pagestyles
  ...
  % \HeaderColor
  \ifdefstring{\ColorTheme}{colourful}{\gdef\HeaderColor{HeaderColor}}{}
  \ifdefstring{\ColorTheme}{BnW}{\gdef\HeaderColor{black}}{}

  % change the color of \headrule to HeaderColor
  \makeatletter
    \renewcommand{\setheadrule}[1]{\ifdim #1=\z@ \let \makeheadrule \@empty \else \def \makeheadrule{\color{\HeaderColor}\rule[-.3\baselineskip]{\linewidth }{#1}}\fi}
  \makeatother
  ...
  {
    \sethead[\thepage][\chaptertitle][\S\,\thesection] % even
    {\S\,\thesection}{\sectiontitle}{\thepage}         % odd
    \headrule
  } 
  ...
  \makeatletter
    ...
    {
    \sethead{\@author}{\CourseName\ Homework \#\theHWNumber}{\thepage\ of\ \makeatletter\@abspage@last\makeatother}
    \headrule
    }
  \makeatother
    ...
    % Hw-In-Main input keyword (continued in InputKeyword_Hw-In-Main.tex)
      % The command \AddToHWEnvList
      \ExplSyntaxOn
        % The clist of environments used in the homework TeX files
