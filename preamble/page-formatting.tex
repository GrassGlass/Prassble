...
%%
% page head
\definecolor{mychapterblue}{RGB}{0,82,155}
  ...
  \newpagestyle{main}[\sffamily\color{mychapterblue}]{
...
% chapter
  ...
  \titleformat{\chapter}[display]
    {\normalfont\bfseries\color{mychapterblue}}
    {\filleft\hspace*{-60pt}%
      ...
      \colorbox{mychapterblue}{\parbox[c][3cm][c]{2.5cm}{%
...
% section
  ...
  \titleformat{\section}[hang]
    {\normalfont\Large\bfseries\color{mychapterblue}}
    {%
    \begingroup
    \setlength\fboxsep{3.5pt}%
    \colorbox{mychapterblue}{\color{white}\thesection}%
    \endgroup
    }
    {5pt}
    {}
