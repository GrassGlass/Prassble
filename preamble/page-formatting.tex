...
% pagestyles
  ...
  {
    \sethead[p.\ \thepage][\chaptertitle][\S\ \thesection] % even
    {\S\ \thesection}{\sectiontitle}{p.\ \thepage}         % odd
    \headrule
  } 
  ...
  \makeatletter
    ...
    {
    \sethead{\@author}{\CourseName\ Homework \#\theHWNumber}{p.\ \thepage\ of\ \makeatletter\@abspage@last\makeatother}
    \headrule
    }
  \makeatother
