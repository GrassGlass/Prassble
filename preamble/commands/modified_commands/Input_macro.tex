...
\cs_new:Npn \_fakeabs_fapaths_to_rel_paths_seq:nnn #1#2#3 {
  % Resets
    ...
    % Reset the seq of final full paths
    \seq_clear:N \g__Prassble_full_paths_output_seq
    ...
    \clist_map_inline:Nn \l__Prassble_files_to_be_input_clist 
        {
            ...
            \seq_put_right:Ne \g__Prassble_full_paths_output_seq {\l__Prassble_full_path_to_parse_tl}

            \tl_use:N \g_Prassble_Input_append_tl
        }
}
\NewDocumentCommand{\FAPath}{ s O{} m }{
  \_fakeabs_fapaths_to_rel_paths_seq:nnn { #1 } { #2 } { #3 }
  \int_compare:nNnF 
