...
% We define a function \_Prassble_Input@core:nnnn for core code of \Input, so that it can be reused for \Import easily and automatically.
\makeatletter
  \cs_new:Npn \_Prassble_Input@core:nnnn #1#2#3#4 {
...
\_Prassble_Input@core:nnnn { #1 } { #2 } { #3 } {\input}
}
%
%
% Easy include of files; \Include works in the exact same way as \Input, except that, expectedly, it does \include instead of \input.
\NewDocumentCommand{\Include}{ s O{} m }{
\_Prassble_Input@core:nnnn { #1 } { #2 } { #3 } {\include}
}
\makeatother
\ExplSyntaxOff